...
Upper_Limit_acc=[maxacc;maxacc;20];
Lower_Limit_acc=[-maxacc;-maxacc;-9.81];
...
subplot(3,2,4);
plot(out.tout,out.simout(:,3)*180/pi,'yellow',out.tout,out.ref(:,4)*180/pi,'red');
title('Psi Angle');
...
figure_x_limits = [-0 15];
figure_y_limits = [-0 15];
figure_z_limits = [-15 0];
